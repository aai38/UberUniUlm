...
public class Filters {
    ...
    public ArrayList setPriceFilter(ArrayList offers, int priceIndex){
    ...
    public ArrayList deletePriceFilter(ArrayList offers){
        priceFilterSet=false;
        this.offers=offers;
        return filter();
    }

    public ArrayList setPlacesFilter(ArrayList offers){
        placesFilterSet=true;
        this.offers=offers;
        return filter();
    }

    public ArrayList deletePlacesFilter(ArrayList offers){
    ...
    public ArrayList setDistanceFilter(ArrayList offers, int distanceIndex, LatLng userPosition){
        String distanceString= context.getResources().getStringArray(R.array.distances)[distanceIndex];
    ...
    public ArrayList deleteDistanceFilter(ArrayList offers){
    ...
    public ArrayList deleteUsernameFilter(ArrayList offers){
        this.offers=offers;
